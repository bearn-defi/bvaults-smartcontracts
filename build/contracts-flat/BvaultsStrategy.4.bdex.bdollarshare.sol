...
contract BvaultsStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public buyBackRate2 = 300; // 3%
    address public buyBackToken2 = address(0xc1dB7603827Cb1a99c50EC1fFf48113259fc6A12); // BDOv2
    ...
    function buyBack2(uint256 _earnedAmt) internal returns (uint256) {
        ...
        if (_pathLength > 0 && earnedAddress != buyBackToken2) {
            _vswapSwapToken(earnedAddress, buyBackToken2, _buyBackAmt, buyBackAddress1);
        } else {
