...
interface BvaultsStrategyStakingInterface extends ethers.utils.Interface {
  functions: {
...
export class BvaultsStrategyStaking extends Contract {
  ...
  interface: BvaultsStrategyStakingInterface;
